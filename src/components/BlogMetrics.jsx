...
export default function BlogMetrics(props) {
  ...
  return (
    <div class="flex my-2 rounded-md outline md:w-1/4 lg:w-1/4 xl:w-1/4 2xl:w-1/6 space-x-5 bg-zinc-300">
      <div class="flex flex-row space-x-1">
        <img class="pl-2" src="/media/eyes.svg" alt="" width="30" />
        <div class="py-2 text-black">{view_count} views</div>
      </div>
      <div class="flex pt-1 text-black">|</div>
      <div class="flex flex-row space-x-1">
        <button onClick={handleLikeClick}>
          <svg
            class="fill-none hover:fill-zinc-500 stroke-black stroke-2 w-5 h-8"
        ...
        <div class="py-2 text-black">{like_count} likes</div>
      </div>
    </div>
  );
}
